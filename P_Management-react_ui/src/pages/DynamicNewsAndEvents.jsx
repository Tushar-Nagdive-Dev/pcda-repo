      ...
      <Breadcrumbs title="News & Events">
        <Breadcrumb>
          <BreadcrumbList>
            ...
            <BreadcrumbSeparator />
            <BreadcrumbItem>
              <BreadcrumbPage className="text-mainprimarycolor">Gallery Details</BreadcrumbPage>
            </BreadcrumbItem>
          </BreadcrumbList>
        </Breadcrumb>
      </Breadcrumbs>
      ...
      <div className="w-full flex flex-col space-y-6 px-custom">
        ...
        <div className="grid grid-cols-4 gap-6 relative">
          {imagePaths.length > 0 ? (
            ...
            <p className="text-center col-span-4 text-gray-500">No images available for this gallery.</p>
          )}
        </div>
      </div>
    </div>
