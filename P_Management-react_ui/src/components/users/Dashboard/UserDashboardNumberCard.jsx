...
function UserDashboardNumberCard({ children }) {
 return (
  <Dialog>
   {/* Trigger */}
   ...
   <DialogContent className="w-fit h-fit p-4 bg-adminCard rounded-xl flex gap-2">
    <div className="min-w-36 border rounded-lg bg-white flex flex-col justify-center items-center p-4 text-red-500">
     <h4 className="font-bold text-[60px] font-raleway">7</h4>
     <div className="flex gap-2 items-center text-red-500">
      <HourglassHigh size={28} />
      <p className="font-raleway font-bold">Pending</p>
     </div>
    </div>
    <div className="min-w-36 border rounded-lg bg-white flex flex-col justify-center items-center p-4 text-green-600">
     <h4 className="font-bold text-[60px] font-raleway">3</h4>
...
export default UserDashboardNumberCard
