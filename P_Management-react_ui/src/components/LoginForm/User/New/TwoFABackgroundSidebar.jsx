...
import '@/components/users/Layout/UserSidebar.css'
import {
 Sidebar,
 SidebarContent,
 SidebarHeader,
...
import UserButtonSideBar from '../../../users/Layout/UserButtonSideBar.jsx'
import { Circle, EnvelopeSimple, Receipt, SignOut } from '@phosphor-icons/react'
...
export function TwoFABackgroundSidebar({ ...props }) {
 ...
 return (
  <Sidebar {...props}>
   <SidebarHeader className="h-[110px] border-b border-sidebar-border px-6 py-8 bg-white flex justify-center items-center">
    <Link to={'#'}>
     <img src={pcdaoLogo} alt="PCDAO's Logo" className="h-[60px] w-auto" />
    </Link>
   </SidebarHeader>
              ...
              <SidebarMenuItem key={subItem?.title}>
               <SidebarMenuButton asChild isActive={subItem?.isActive}>
                <div className="flex gap-2">
                 <Circle size={16} />
                 <NavLink to={subItem?.url} className="text-lg font-raleway">
                  {subItem?.title}
                 </NavLink>
                </div>
               </SidebarMenuButton>
    ...
    <div className="w-full h-[44px] bg-adminBreadCrumbsBg flex justify-center items-center">
     <Dialog>
      ...
      <DialogContent className="font-raleway text-lg text-justify w-[900px]">
       ...
       The information provided on this website is based on relevant Govt.
       orders, Army Instructions and Army Orders. However contents of this web
       site cannot be quoted as authority in any of the correspondence with the
       Office of the Principal Controller of Defence Accounts (Officers) or with
       any other organisation. No classified information will be provided or
       received through this web site. The copyright and ownership as regard to
       the domain name, contents and web design rests with the Principal
       Controller of Defence Accounts (Officers), Golibar Maidan, Pune, India -
       411001.
