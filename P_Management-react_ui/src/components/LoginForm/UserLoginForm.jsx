 ...
 return (
  <React.Fragment>
   <div className="w-full h-full border-l-slate-200 border-l-2">
    <div className="mx-auto flex w-full h-full flex-col justify-center md:max-lg:space-y-2 mid_hd_screen:max-full_hd_screen:space-y-3 space-y-12 sm:w-[450px]">
      ...
      <React.Fragment>
       <div className="text-left ">
        <h2 className="md:max-lg:text-xl mid_hd_screen:max-full_hd_screen:text-3xl text-4xl tracking-tight raleway-font text-center">
         Welcome to{' '}
         <span className="text-statebluecolor font-black">PCDA(O)</span>
        </h2>
       </div>
       <Form {...form}>
        <form onSubmit={form.handleSubmit(onSubmit)}>
         <div className="md:max-lg:space-y-1 mid_hd_screen:max-full_hd_screen:space-y-2 space-y-4 mb-7">
          <div className="flex flex-col space-y-3 mt-4">
           <h2 className="md:max-lg:text-xl text-2xl tracking-tight raleway-font">
            Login
           </h2>
          </div>
          <FormField
